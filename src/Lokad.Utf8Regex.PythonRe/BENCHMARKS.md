...
- Generated: `2026-08-26T11:11:47.8749886+00:00`
- Snapshot SHA-256: `9150C8149F15B0335B9E2AEF9FC91284889D1312D5D63B125F0E361CDA21AE11`
- Schema: `6`
- Cases: `28`
...
| `literal/fullmatch` | `FullMatch` | ConsumedGroupZeroRanges | Managed faster | 0.034 us | 0.212 us | 0.16x | 0.245 us | 0.094 us | 0 B |
...
| `unicode/fullmatch` | `FullMatch` | ConsumedGroupZeroRanges | Inconclusive | 13.037 us | 13.558 us | 0.96x | 19.217 us | 25.377 us | 14,360 B |
...
| `literal/fullmatch` | `_sre C Pattern.fullmatch` | `Utf8Regex/AsciiSimplePattern; full-match value ranges` | Rbyte 0.14x [0.14, 0.15]; Inconclusive |
