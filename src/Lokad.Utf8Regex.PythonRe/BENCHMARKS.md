...
- Generated: `2026-08-26T11:24:53.5691016+00:00`
- Snapshot SHA-256: `E781F9AE7F8F57DE5CDC58656B3097FA799AE6FDD0140F3F7171B2B1D0BF29C5`
- Schema: `6`
- Cases: `28`
...
| `family/count` | `Count` | ScalarResult | Managed faster | 72.752 us | 1,283.974 us | 0.06x | 1,231.496 us | 462.747 us | 0 B |
...
| `findall/one-capture-strings` | `FindAllStrings` | EagerMaterializedResult | Inconclusive | 231.625 us | 134.593 us | 1.75x | 126.792 us | 359.547 us | 936,224 B |
...
| `literal/ismatch` | `IsMatch` | ScalarResult | Managed faster | 1.875 us | 12.107 us | 0.15x | 14.877 us | 12.075 us | 0 B |
...
| `prefix/match` | `Match` | ConsumedGroupZeroRanges | Inconclusive | 2.263 us | 0.172 us | 11.25x | 0.781 us | 1.444 us | 33,024 B |
...
| `prefix/match` | `_sre C Pattern.match` | `Utf8Regex/FallbackRegex; anchored value ranges` | Rbyte 9.10x [8.32, 13.19]; NotApplicable |
