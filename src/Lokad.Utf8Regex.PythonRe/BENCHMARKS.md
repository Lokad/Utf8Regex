...
- Generated: `2026-08-26T09:49:30.2539806+00:00`
- Snapshot SHA-256: `284701F3618D1A818297531CFE555CCC65530DAD74E9EB7D2D9AE11EA0B00A34`
- Schema: `4`
- Cases: `28`
- Public Status: `0` managed faster, `0` equivalent, `0` CPython faster, `4` inconclusive, `24` unqualified
...
| `family/count` | `Count` | ScalarResult | Inconclusive | 108.599 us | 1,968.193 us | 0.06x | 1,231.496 us | 462.747 us | 0 B |
...
| `findall/one-capture-strings` | `FindAllStrings` | EagerMaterializedResult | Unqualified | 303.571 us | 155.212 us | 1.97x | 126.792 us | 359.547 us | 936,224 B |
...
| `literal/search-miss` | `Search` | ConsumedGroupZeroRanges | Inconclusive | 61.197 us | 16.399 us | 3.58x | 14.464 us | 10.417 us | 131,096 B |
| `prefix/match` | `Match` | ConsumedGroupZeroRanges | Inconclusive | 3.173 us | 0.181 us | 17.52x | 0.781 us | 1.444 us | 33,024 B |
...
| `replacement/subn-string` | `SubnString` | EagerMaterializedResult | Inconclusive | 185.303 us | 84.817 us | 2.13x | 64.130 us | 121.769 us | 74,241 B |
