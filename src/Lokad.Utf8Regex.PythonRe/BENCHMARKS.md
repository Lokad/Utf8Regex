...
- Snapshot SHA-256: `941DBA39EFB6BB4EFDFE52E2D546EDE8E0EAA7BB4BB01B3BE3D9BDFC6FD6C92C`
- Schema: `4`
- Cases: `28`
...
| Case | Operation | Status | PythonRe elapsed | CPython predecoded elapsed | Rstrong | CPython + decode elapsed | .NET + decode elapsed | PythonRe alloc |
|---|---|---|---:|---:|---:|---:|---:|---:|
| `capture/search-detailed` | `SearchDetailed` | Unqualified | 0.501 us | 2.489 us | 0.20x | 2.602 us | 0.350 us | 896 B |
| `class-run/count` | `Count` | Unqualified | 504.865 us | 1,415.960 us | 0.36x | 1,424.645 us | 620.138 us | 172,056 B |
| `family/count` | `Count` | Unqualified | 68.200 us | 1,240.842 us | 0.05x | 1,231.496 us | 462.747 us | 0 B |
| `findall/full-strings` | `FindAllStrings` | Unqualified | 244.742 us | 303.417 us | 0.81x | 219.217 us | 248.829 us | 165,936 B |
| `findall/full-utf8` | `FindAllUtf8` | Unqualified | 268.899 us | 309.247 us | 0.87x | 406.854 us | 318.232 us | 165,936 B |
| `findall/many-capture-strings` | `FindAllStrings` | Unqualified | 388.206 us | 196.091 us | 1.98x | 201.521 us | 449.797 us | 1,331,488 B |
| `findall/many-capture-utf8` | `FindAllUtf8` | Unqualified | 412.906 us | 789.879 us | 0.52x | 873.741 us | 534.325 us | 1,528,096 B |
| `findall/one-capture-strings` | `FindAllStrings` | Unqualified | 278.100 us | 124.845 us | 2.23x | 126.792 us | 359.547 us | 936,224 B |
| `findall/unicode-capture-utf8` | `FindAllUtf8` | Unqualified | 299.098 us | 359.654 us | 0.83x | 359.520 us | 335.570 us | 785,704 B |
| `findall/unicode-full-strings` | `FindAllStrings` | Unqualified | 45.029 us | 21.572 us | 2.09x | 24.031 us | 42.099 us | 24,600 B |
| `findall/unicode-full-utf8` | `FindAllUtf8` | Unqualified | 58.445 us | 38.623 us | 1.51x | 47.145 us | 60.234 us | 24,600 B |
| `iteration/finditer-detailed` | `FindIterDetailed` | Unqualified | 173.765 us | 3,466.165 us | 0.05x | 3,139.237 us | 153.941 us | 406,736 B |
| `literal/fullmatch` | `FullMatch` | Unqualified | 0.195 us | 0.207 us | 0.94x | 0.245 us | 0.094 us | 0 B |
...
| `prefix/match` | `Match` | Unqualified | 1.626 us | 0.170 us | 9.59x | 0.781 us | 1.444 us | 33,024 B |
...
| `replacement/fixed-utf8` | `ReplaceUtf8` | Unqualified | 159.901 us | 122.880 us | 1.30x | 126.579 us | 162.701 us | 188,922 B |
| `replacement/subn-string` | `SubnString` | Unqualified | 127.518 us | 62.295 us | 2.05x | 64.130 us | 121.769 us | 74,209 B |
| `replacement/subn-utf8` | `SubnUtf8` | Unqualified | 130.351 us | 61.397 us | 2.12x | 62.087 us | 120.898 us | 94,713 B |
| `split/captures` | `SplitStrings` | Unqualified | 135.959 us | 142.920 us | 0.95x | 142.175 us | 134.880 us | 499,032 B |
| `split/no-captures` | `SplitStrings` | Unqualified | 73.508 us | 128.601 us | 0.57x | 126.317 us | 74.816 us | 171,328 B |
| `unicode/count` | `Count` | Unqualified | 92.217 us | 211.684 us | 0.44x | 271.193 us | 185.111 us | 0 B |
| `unicode/fullmatch` | `FullMatch` | Unqualified | 27.265 us | 12.613 us | 2.16x | 19.217 us | 25.377 us | 14,360 B |
| `zero-width/count` | `Count` | Unqualified | 18.474 us | 584.444 us | 0.03x | 578.748 us | 295.137 us | 34,840 B |
