...
- Schema: `9`
- Snapshot SHA-256: `E2AE0BA2261777314C297983A38009E603AF804A6BD9950A3E563A58E299C41C`
- Latest managed row measurement: `2026-08-25T14:01:31.3445003+00:00`
- Latest PCRE.NET / PCRE2 NFA measurement: `2026-08-25T14:01:31.3445003+00:00`
...
- Comparator Status: `4` managed faster, `0` equivalent, `8` native faster, `7` inconclusive, `81` unqualified, `26` excluded
...
| `simple/httpclient-caseless` | **Inconclusive** | 45 B | 0.054 us | 0.159 us | 0.34x | 0.33–0.54x | -0.105 us | 9 pairs; 29/39 ms; 541,534/247,771 ops/lane; IQR 1.034/1.003 | `Pcre2Character` | 0.929 us | 0.070 us | 0.091 us | 0.59x | 0 B | 0 B |
...
| `simple/httpclient-caseless` | **Managed faster** | 45 B | 0.378 us | 0.682 us | 0.55x | 0.54–0.57x | -0.305 us | 9 pairs; 40/40 ms; 106,745/58,845 ops/lane; IQR 1.050/1.006 | `Pcre2Character` | 0.772 us | 0.265 us | 0.295 us | 1.28x | 0 B | 0 B |
...
| `simple/httpclient-caseless` | **Inconclusive** | 45 B | 0.672 us | 0.686 us | 0.98x | 0.95–1.00x | -0.016 us | 9 pairs; 40/40 ms; 59,425/58,660 ops/lane; IQR 1.046/1.008 | `Pcre2Character` | 13.023 us | 0.287 us | 0.339 us | 1.98x | 0 B | 0 B |
...
| `simple/httpclient-caseless` | **Managed faster** | 45 B | 0.431 us | 0.688 us | 0.63x | 0.62–0.63x | -0.258 us | 9 pairs; 41/40 ms; 94,330/57,929 ops/lane; IQR 1.009/1.005 | `Pcre2Character` | — | — | — | — | 0 B | 0 B |
...
| `pcre2/duplicate-names` | **Native faster** | 23 B | 0.651 us | 0.536 us | 1.22x | 1.21–1.24x | +0.116 us | 9 pairs; 40/41 ms; 60,868/75,764 ops/lane; IQR 1.004/1.004 | `Pcre2Backtracking` | 0 B | 0 B | 24.577 us | 83,248 B |
...
| `pcre2/duplicate-names` | **Native faster** | 23 B | 0.886 us | 0.549 us | 1.64x | 1.56–1.64x | +0.347 us | 9 pairs; 40/40 ms; 45,611/73,530 ops/lane; IQR 1.067/1.074 | `Pcre2Backtracking` | 0 B | 0 B | 25.009 us | 83,248 B |
...
| `pcre2/duplicate-names` | **Native faster** | 23 B | 0.710 us | 0.541 us | 1.31x | 1.28–1.36x | +0.166 us | 9 pairs; 39/41 ms; 55,269/75,128 ops/lane; IQR 1.046/1.016 | `Pcre2Backtracking` | 0 B | 0 B | 23.951 us | 83,248 B |
