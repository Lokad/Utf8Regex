...
- Schema: `9`
- Snapshot SHA-256: `C95736060B4FEA9BAE26D6E2E2FDFB1868B17257A5BA5A5822A81A081D2F817F`
...
- Comparator Status: `33` managed faster, `0` equivalent, `4` native faster, `6` inconclusive, `57` unqualified, `26` excluded
- Rows with paired qualification evidence: `43/100`
...
| `simple/loglevel-multiline` | **Native faster** | 67 B | 0.552 us | 0.243 us | 2.27x | 2.25–2.33x | +0.309 us | 9 pairs; 39/39 ms; 71,334/161,817 ops/lane; IQR 1.004/1.012 | `Pcre2Backtracking` | 0.371 us | 0.043 us | 0.056 us | 9.81x | 0 B | 0 B |
...
| `simple/loglevel-multiline` | **Native faster** | 67 B | 1.278 us | 0.585 us | 2.20x | 2.14–2.22x | +0.697 us | 9 pairs; 39/39 ms; 30,506/67,535 ops/lane; IQR 1.014/1.014 | `Pcre2Backtracking` | 0.507 us | 0.085 us | 0.101 us | 12.66x | 0 B | 0 B |
...
| `simple/loglevel-multiline` | **Native faster** | 67 B | 1.481 us | 0.577 us | 2.54x | 2.49–2.59x | +0.902 us | 9 pairs; 40/42 ms; 26,683/73,418 ops/lane; IQR 1.010/1.025 | `Pcre2Backtracking` | 11.926 us | 0.097 us | 0.205 us | 7.23x | 0 B | 0 B |
...
| `simple/loglevel-multiline` | **Native faster** | 67 B | 1.276 us | 0.589 us | 2.16x | 2.14–2.19x | +0.686 us | 9 pairs; 40/39 ms; 31,444/67,032 ops/lane; IQR 1.014/1.007 | `Pcre2Backtracking` | — | — | — | — | 0 B | 0 B |
...
| `pcre2/branch-reset-backref` | **Managed faster** | 23 B | 0.029 us | 0.155 us | 0.19x | 0.19–0.19x | -0.125 us | 11 pairs; 46/41 ms; 1,599,463/265,928 ops/lane; IQR 1.042/1.028 | `Pcre2Backtracking` | 0 B | 0 B | 197.541 us | 124,200 B |
...
| `pcre2/branch-reset-backref` | **Managed faster** | 23 B | 0.146 us | 0.629 us | 0.23x | 0.22–0.23x | -0.483 us | 11 pairs; 42/41 ms; 291,710/65,765 ops/lane; IQR 1.047/1.067 | `Pcre2Backtracking` | 0 B | 0 B | 189.766 us | 124,200 B |
| `pcre2/branch-reset-basic` | **Managed faster** | 17 B | 0.141 us | 0.650 us | 0.22x | 0.21–0.22x | -0.509 us | 9 pairs; 32/40 ms; 228,876/61,400 ops/lane; IQR 1.017/1.006 | `Pcre2Backtracking` | 0 B | 0 B | 19.301 us | 39,288 B |
| `pcre2/branch-reset-followup` | **Managed faster** | 31 B | 0.148 us | 0.582 us | 0.25x | 0.24–0.25x | -0.434 us | 9 pairs; 34/41 ms; 227,410/69,975 ops/lane; IQR 1.035/1.064 | `Pcre2Backtracking` | 0 B | 0 B | 19.176 us | 43,696 B |
...
| `pcre2/kreset-atomic-alt` | **Managed faster** | 13 B | 0.112 us | 0.483 us | 0.23x | 0.22–0.23x | -0.373 us | 9 pairs; 31/39 ms; 278,770/81,537 ops/lane; IQR 1.027/1.030 | `Pcre2Backtracking` | 0 B | 0 B | 16.437 us | 36,752 B |
| `pcre2/kreset-bar-or-baz` | **Managed faster** | 26 B | 0.111 us | 0.559 us | 0.20x | 0.19–0.21x | -0.448 us | 9 pairs; 40/41 ms; 359,200/72,802 ops/lane; IQR 1.026/1.054 | `Pcre2Backtracking` | 0 B | 0 B | 18.100 us | 41,728 B |
| `pcre2/kreset-captured-repeat` | **Excluded** | 14 B | 1.883 us | — | — | — | — | — | `—` | 0 B | — | 16.105 us | 35,552 B |
| `pcre2/kreset-global` | **Managed faster** | 26 B | 0.063 us | 0.475 us | 0.13x | 0.13–0.14x | -0.412 us | 9 pairs; 31/40 ms; 496,596/83,731 ops/lane; IQR 1.022/1.006 | `Pcre2Backtracking` | 0 B | 0 B | 16.647 us | 35,376 B |
...
| `pcre2/branch-reset-backref` | **Managed faster** | 23 B | 0.438 us | 0.597 us | 0.73x | 0.73–0.76x | -0.159 us | 11 pairs; 39/40 ms; 90,220/67,377 ops/lane; IQR 1.040/1.043 | `Pcre2Backtracking` | 0 B | 0 B | 152.700 us | 123,272 B |
| `pcre2/branch-reset-basic` | **Managed faster** | 17 B | 0.476 us | 0.658 us | 0.72x | 0.72–0.73x | -0.184 us | 9 pairs; 40/39 ms; 85,121/59,694 ops/lane; IQR 1.008/1.005 | `Pcre2Backtracking` | 0 B | 0 B | 17.497 us | 39,288 B |
| `pcre2/branch-reset-followup` | **Managed faster** | 31 B | 0.438 us | 0.582 us | 0.75x | 0.74–0.75x | -0.144 us | 9 pairs; 40/39 ms; 92,256/67,722 ops/lane; IQR 1.005/1.026 | `Pcre2Backtracking` | 0 B | 0 B | 32.857 us | 43,696 B |
...
| `pcre2/kreset-atomic-alt` | **Managed faster** | 13 B | 0.423 us | 0.488 us | 0.87x | 0.86–0.87x | -0.065 us | 9 pairs; 40/40 ms; 95,092/81,802 ops/lane; IQR 1.009/1.002 | `Pcre2Backtracking` | 0 B | 0 B | 16.322 us | 36,752 B |
| `pcre2/kreset-bar-or-baz` | **Managed faster** | 26 B | 0.425 us | 0.548 us | 0.77x | 0.77–0.78x | -0.125 us | 9 pairs; 41/41 ms; 96,150/75,135 ops/lane; IQR 1.006/1.010 | `Pcre2Backtracking` | 0 B | 0 B | 18.507 us | 41,728 B |
| `pcre2/kreset-captured-repeat` | **Excluded** | 14 B | 5.294 us | — | — | — | — | — | `—` | 0 B | — | 15.867 us | 35,552 B |
| `pcre2/kreset-global` | **Managed faster** | 26 B | 0.380 us | 0.485 us | 0.78x | 0.78–0.80x | -0.107 us | 9 pairs; 40/40 ms; 106,155/83,391 ops/lane; IQR 1.011/1.004 | `Pcre2Backtracking` | 0 B | 0 B | 16.110 us | 35,376 B |
...
| `pcre2/branch-reset-backref` | **Managed faster** | 23 B | 0.249 us | 0.607 us | 0.42x | 0.41–0.43x | -0.346 us | 11 pairs; 40/40 ms; 159,478/66,499 ops/lane; IQR 1.050/1.037 | `Pcre2Backtracking` | 0 B | 0 B | 68.966 us | 123,125 B |
| `pcre2/branch-reset-basic` | **Managed faster** | 17 B | 0.277 us | 0.660 us | 0.42x | 0.41–0.42x | -0.382 us | 9 pairs; 41/41 ms; 149,081/62,285 ops/lane; IQR 1.004/1.012 | `Pcre2Backtracking` | 0 B | 0 B | 17.641 us | 39,288 B |
| `pcre2/branch-reset-followup` | **Managed faster** | 31 B | 0.246 us | 0.587 us | 0.42x | 0.42–0.42x | -0.342 us | 9 pairs; 40/38 ms; 163,163/65,544 ops/lane; IQR 1.009/1.008 | `Pcre2Backtracking` | 0 B | 0 B | 18.478 us | 43,696 B |
...
| `pcre2/kreset-atomic-alt` | **Managed faster** | 13 B | 0.249 us | 0.502 us | 0.49x | 0.49–0.51x | -0.253 us | 9 pairs; 43/40 ms; 173,201/80,541 ops/lane; IQR 1.041/1.038 | `Pcre2Backtracking` | 0 B | 0 B | 16.725 us | 36,752 B |
| `pcre2/kreset-bar-or-baz` | **Managed faster** | 26 B | 0.252 us | 0.567 us | 0.45x | 0.44–0.46x | -0.310 us | 9 pairs; 40/41 ms; 158,568/72,179 ops/lane; IQR 1.023/1.035 | `Pcre2Backtracking` | 0 B | 0 B | 17.599 us | 41,728 B |
| `pcre2/kreset-captured-repeat` | **Excluded** | 14 B | 1.905 us | — | — | — | — | — | `—` | 0 B | — | 15.935 us | 35,552 B |
| `pcre2/kreset-global` | **Managed faster** | 26 B | 0.179 us | 0.484 us | 0.37x | 0.37–0.37x | -0.304 us | 9 pairs; 40/39 ms; 224,315/81,151 ops/lane; IQR 1.004/1.013 | `Pcre2Backtracking` | 0 B | 0 B | 16.314 us | 35,376 B |
