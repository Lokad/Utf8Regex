...
- Schema: `9`
- Snapshot SHA-256: `131BF2F006C0111EBAB755EFA9DA810B9964D50EDFBD4148801C225B545A19B7`
- Latest managed row measurement: `2026-08-25T13:22:32.4101576+00:00`
- Latest PCRE.NET / PCRE2 NFA measurement: `2026-08-25T13:22:32.4101576+00:00`
...
- Comparator Status: `5` managed faster, `0` equivalent, `9` native faster, `5` inconclusive, `81` unqualified, `26` excluded
...
| `common/email-miss` | **Native faster** | 35 B | 1.227 us | 0.300 us | 4.09x | 4.04–4.17x | +0.927 us | 9 pairs; 40/39 ms; 32,206/131,708 ops/lane; IQR 1.015/1.023 | `Pcre2Backtracking` | 0.638 us | 0.296 us | 0.313 us | 3.92x | 0 B | 0 B |
...
| `simple/foo-dense` | **Inconclusive** | 18 B | 0.037 us | 0.137 us | 0.28x | 0.27–0.29x | -0.100 us | 9 pairs; 31/34 ms; 821,744/247,757 ops/lane; IQR 1.385/1.217 | `Pcre2Literal` | 0.301 us | 0.052 us | 0.070 us | 0.53x | 0 B | 0 B |
| `simple/foo-optional-bar` | **Unqualified** | 23 B | 0.335 us | 0.086 us | 3.89x | — | +0.249 us | — | `—` | 1.293 us | 0.053 us | 0.068 us | 4.93x | 0 B | — |
| `simple/httpclient-caseless` | **Managed faster** | 45 B | 0.063 us | 0.163 us | 0.39x | 0.38–0.39x | -0.100 us | 9 pairs; 34/41 ms; 530,202/248,588 ops/lane; IQR 1.009/1.012 | `Pcre2Character` | 0.929 us | 0.070 us | 0.091 us | 0.69x | 0 B | 0 B |
...
| `simple/foo-dense` | **Inconclusive** | 18 B | 0.233 us | 0.468 us | 0.50x | 0.48–0.53x | -0.242 us | 9 pairs; 43/41 ms; 184,754/88,447 ops/lane; IQR 1.237/1.162 | `Pcre2Literal` | 0.189 us | 0.189 us | 0.196 us | 1.19x | 0 B | 0 B |
| `simple/foo-optional-bar` | **Unqualified** | 23 B | 1.075 us | 0.650 us | 1.65x | — | +0.425 us | — | `—` | 1.231 us | 0.194 us | 0.205 us | 5.25x | 0 B | — |
| `simple/httpclient-caseless` | **Managed faster** | 45 B | 0.405 us | 0.686 us | 0.59x | 0.59–0.61x | -0.281 us | 9 pairs; 38/40 ms; 94,626/58,718 ops/lane; IQR 1.030/1.006 | `Pcre2Character` | 0.772 us | 0.265 us | 0.295 us | 1.37x | 0 B | 0 B |
...
| `simple/foo-dense` | **Native faster** | 18 B | 0.744 us | 0.461 us | 1.61x | 1.60–1.64x | +0.282 us | 9 pairs; 40/36 ms; 53,713/79,005 ops/lane; IQR 1.019/1.003 | `Pcre2Literal` | 0.976 us | 0.215 us | 0.243 us | 3.06x | 0 B | 0 B |
| `simple/foo-optional-bar` | **Unqualified** | 23 B | 4.496 us | 0.322 us | 13.96x | — | +4.174 us | — | `—` | 16.080 us | 0.411 us | 0.433 us | 10.38x | 0 B | — |
| `simple/httpclient-caseless` | **Native faster** | 45 B | 1.013 us | 0.696 us | 1.44x | 1.38–1.47x | +0.308 us | 9 pairs; 43/39 ms; 42,627/55,449 ops/lane; IQR 1.032/1.029 | `Pcre2Character` | 13.023 us | 0.287 us | 0.339 us | 2.99x | 0 B | 0 B |
...
| `simple/foo-dense` | **Managed faster** | 18 B | 0.245 us | 0.461 us | 0.53x | 0.53–0.54x | -0.216 us | 9 pairs; 40/40 ms; 163,288/86,986 ops/lane; IQR 1.011/1.004 | `Pcre2Literal` | — | — | — | — | 0 B | 0 B |
| `simple/foo-optional-bar` | **Unqualified** | 23 B | 1.454 us | 0.309 us | 4.71x | — | +1.145 us | — | `—` | — | — | — | — | 0 B | — |
| `simple/httpclient-caseless` | **Managed faster** | 45 B | 0.432 us | 0.695 us | 0.62x | 0.61–0.65x | -0.267 us | 9 pairs; 40/40 ms; 91,396/57,810 ops/lane; IQR 1.028/1.011 | `Pcre2Character` | — | — | — | — | 0 B | 0 B |
...
| `pcre2/branch-reset-followup` | **Native faster** | 31 B | 0.871 us | 0.580 us | 1.50x | 1.49–1.53x | +0.287 us | 9 pairs; 40/40 ms; 46,426/68,204 ops/lane; IQR 1.012/1.006 | `Pcre2Backtracking` | 0 B | 0 B | 19.176 us | 43,696 B |
| `pcre2/branch-reset-nested` | **Unqualified** | 22 B | 0.967 us | 0.689 us | 1.40x | — | +0.278 us | — | `—` | 0 B | — | 17.950 us | 43,304 B |
| `pcre2/duplicate-names` | **Native faster** | 23 B | 0.825 us | 0.533 us | 1.55x | 1.44–1.59x | +0.292 us | 9 pairs; 44/39 ms; 53,133/73,948 ops/lane; IQR 1.008/1.004 | `Pcre2Backtracking` | 0 B | 0 B | 24.577 us | 83,248 B |
| `pcre2/grapheme-cluster` | **Unqualified** | 248 B | 2.311 us | 4.834 us | 0.48x | — | -2.523 us | — | `—` | 0 B | — | 18.705 us | 31,600 B |
| `pcre2/kreset-atomic-alt` | **Unqualified** | 13 B | 0.946 us | 0.498 us | 1.90x | — | +0.448 us | — | `—` | 0 B | — | 16.437 us | 36,752 B |
...
| `pcre2/branch-reset-followup` | **Native faster** | 31 B | 1.515 us | 0.590 us | 2.58x | 2.51–2.70x | +0.928 us | 9 pairs; 40/41 ms; 26,597/68,858 ops/lane; IQR 1.055/1.044 | `Pcre2Backtracking` | 0 B | 0 B | 32.857 us | 43,696 B |
| `pcre2/branch-reset-nested` | **Unqualified** | 22 B | 4.381 us | 0.413 us | 10.61x | — | +3.968 us | — | `—` | 0 B | — | 22.111 us | 43,304 B |
| `pcre2/duplicate-names` | **Native faster** | 23 B | 1.415 us | 0.546 us | 2.60x | 2.56–2.69x | +0.867 us | 9 pairs; 37/37 ms; 26,011/68,547 ops/lane; IQR 1.016/1.037 | `Pcre2Backtracking` | 0 B | 0 B | 25.009 us | 83,248 B |
| `pcre2/grapheme-cluster` | **Unqualified** | 248 B | 5.894 us | 2.134 us | 2.76x | — | +3.760 us | — | `—` | 0 B | — | 16.762 us | 31,600 B |
| `pcre2/kreset-atomic-alt` | **Unqualified** | 13 B | 4.455 us | 0.231 us | 19.29x | — | +4.224 us | — | `—` | 0 B | — | 16.322 us | 36,752 B |
...
| `pcre2/branch-reset-followup` | **Native faster** | 31 B | 0.914 us | 0.590 us | 1.56x | 1.54–1.59x | +0.327 us | 9 pairs; 39/40 ms; 42,960/68,406 ops/lane; IQR 1.009/1.040 | `Pcre2Backtracking` | 0 B | 0 B | 18.478 us | 43,696 B |
| `pcre2/branch-reset-nested` | **Unqualified** | 22 B | 1.017 us | 0.413 us | 2.46x | — | +0.604 us | — | `—` | 0 B | — | 18.129 us | 43,304 B |
| `pcre2/duplicate-names` | **Native faster** | 23 B | 0.843 us | 0.538 us | 1.56x | 1.55–1.57x | +0.302 us | 9 pairs; 40/37 ms; 47,752/69,521 ops/lane; IQR 1.022/1.023 | `Pcre2Backtracking` | 0 B | 0 B | 23.951 us | 83,248 B |
| `pcre2/grapheme-cluster` | **Unqualified** | 248 B | 0.924 us | 0.597 us | 1.55x | — | +0.327 us | — | `—` | 0 B | — | 16.800 us | 31,600 B |
| `pcre2/kreset-atomic-alt` | **Unqualified** | 13 B | 0.874 us | 0.230 us | 3.80x | — | +0.644 us | — | `—` | 0 B | — | 16.725 us | 36,752 B |
