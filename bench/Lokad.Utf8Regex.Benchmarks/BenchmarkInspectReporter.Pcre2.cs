...
internal static partial class BenchmarkInspectReporter
{
    ...
    public static int RunInspectUtf8Pcre2Case(string caseId)
    {
        ...
        if ((benchmarkCase.SupportedOperations & Utf8Pcre2BenchmarkOperation.IsMatch) != 0)
        {
            ...
            Console.WriteLine($"IsMatchLiteralTok : {execution.VmLiteralTokenSteps}");
            Console.WriteLine($"IsMatchClassTok   : {execution.VmClassTokenSteps}");
            Console.WriteLine($"IsMatchBoundaryTok: {execution.VmBoundaryAnchorTokenSteps}");
            Console.WriteLine($"IsMatchOtherTok   : {execution.VmOtherTokenSteps}");
            ...
            Console.WriteLine($"IsMatchAssertions : {execution.VmAssertionSubroutineSteps}");
            Console.WriteLine($"IsMatchControls   : {execution.VmControlSteps}");
            Console.WriteLine($"IsMatchAccepts    : {execution.VmAcceptSteps}");
            ...
            Console.WriteLine($"IsMatchWorkInitial: {execution.WorkspaceInitialStackRents}");
            ...
            Console.WriteLine($"IsMatchWorkControl: {execution.WorkspaceControlRents}");
    ...
    public static int RunMeasureUtf8Pcre2CompatibleCase(string caseId, string? iterationsText, string? samplesText)
    {
        ...
        if ((benchmarkCase.SupportedOperations & Utf8Pcre2BenchmarkOperation.Replace) != 0)
        {
            ...
            Measure("DecodeReplace", samples, iterations, () => RegexBenchmarkResult.ReplaceUtf8Length(context.Regex!, Encoding.UTF8.GetString(context.InputBytes), context.Replacement));
            Measure("PredecodedReplace", samples, iterations, () => RegexBenchmarkResult.ReplaceUtf8Length(context.Regex!, context.InputString, context.Replacement));
        }
    ...
    private static void WritePcre2EnumeratorLayout()
    {
        ...
        Console.WriteLine($"CandidateSearchB  : {Pcre2CandidateSearchProgram.DebugSizeInBytes}");
    ...
    public static int RunEmitUtf8Pcre2ManagedPerfLedger(string? iterationsText)
    {
        ...
        foreach (var caseId in cases)
        {
            ...
            var predecodedReplace = MeasureMicroseconds(samples, iterations, () => RegexBenchmarkResult.ReplaceUtf8Length(context.Regex!, context.InputString, context.Replacement));
