...
[MemoryDiagnoser]
[BenchmarkCategory("DotNetPerformanceReplica", "Dictionary")]
public class DotNetPerformanceReplicaDictionaryBenchmarks
{
    ...
    public IEnumerable<string> CaseIds => DotNetPerformanceReplicaBenchmarkCatalog.GetIds("dictionary", DotNetPerformanceReplicaBenchmarkModel.Count);
