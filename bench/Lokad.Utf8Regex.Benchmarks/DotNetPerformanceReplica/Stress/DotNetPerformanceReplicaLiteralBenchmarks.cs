...
[MemoryDiagnoser]
[BenchmarkCategory("DotNetPerformanceReplica", "Literal")]
public class DotNetPerformanceReplicaLiteralBenchmarks
{
    ...
    public IEnumerable<string> CaseIds => DotNetPerformanceReplicaBenchmarkCatalog.GetIds("literal", DotNetPerformanceReplicaBenchmarkModel.Count);
