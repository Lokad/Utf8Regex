...
internal static class DotNetPerformanceReplicaBenchmarkCatalog
{
    ...
    [
        ...
        // Non-published controls for invariant ignore-case family diagnostics.
        new("literal-alternate/sherlock-casei-en-nomatch", "literal-alternate", DotNetPerformanceReplicaBenchmarkModel.Count,
            pattern: "Mycroft Holmes|Mary Morstan|Mrs Hudson|Sebastian Moran|Charles Augustus Milverton", regexRelativePath: null, regexPerLineAlternate: false,
            haystackRelativePath: @"opensubtitles\en-sampled.txt", haystackInline: null, haystackUtf8Lossy: false, haystackLineStart: null, haystackLineEnd: null,
            options: RegexOptions.IgnoreCase | RegexOptions.CultureInvariant, expectedCount: 0, isDevelopmentSlice: true, origin: "synthetic ignore-case no-match :: sherlock-en"),
        new("literal-alternate/sherlock-casei-en-mixed", "literal-alternate", DotNetPerformanceReplicaBenchmarkModel.Count,
            pattern: "Sherlock Holmes|John Watson|Mycroft Holmes|Mary Morstan|Mrs Hudson", regexRelativePath: null, regexPerLineAlternate: false,
            haystackRelativePath: @"opensubtitles\en-sampled.txt", haystackInline: null, haystackUtf8Lossy: false, haystackLineStart: null, haystackLineEnd: null,
            options: RegexOptions.IgnoreCase | RegexOptions.CultureInvariant, expectedCount: 533, isDevelopmentSlice: true, origin: "synthetic ignore-case mixed :: sherlock-en"),
        new("literal-alternate/sherlock-casei-en-shared-prefix", "literal-alternate", DotNetPerformanceReplicaBenchmarkModel.Count,
            pattern: "Sherlock Holmes|Sherlock Watson|Sherlock Adler|Sherlock Lestrade|Sherlock Moriarty", regexRelativePath: null, regexPerLineAlternate: false,
            haystackRelativePath: @"opensubtitles\en-sampled.txt", haystackInline: null, haystackUtf8Lossy: false, haystackLineStart: null, haystackLineEnd: null,
            options: RegexOptions.IgnoreCase | RegexOptions.CultureInvariant, expectedCount: 522, isDevelopmentSlice: true, origin: "synthetic ignore-case shared-prefix :: sherlock-en"),
        // Source: dotnet-performance/benchmarks/definitions/curated/02-literal-alternate.toml
