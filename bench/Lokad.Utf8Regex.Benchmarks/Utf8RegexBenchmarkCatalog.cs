...
internal static class Utf8RegexBenchmarkCatalog
{
    ...
    [
        ...
        new(
            "ismatch_utf8_literal_early_hit",
            "LiteralUtf8",
            Utf8RegexBenchmarkOperation.IsMatch,
            "café",
            "café " + BuildRepeated("resume ", 2048),
            RegexOptions.CultureInvariant,
            replacement: null,
            expectedSupport: "Native",
            notes: "BMP UTF-8 literal at the beginning of a large valid subject."),
        new(
            "ismatch_utf8_literal_miss",
            "LiteralUtf8",
            Utf8RegexBenchmarkOperation.IsMatch,
            "café",
            ...
            replacement: null,
            expectedSupport: "Native",
            notes: "No-match BMP UTF-8 literal scan over a large valid subject."),
        new(
        ...
        new(
            "ismatch_utf8_lookahead_early_hit",
            "Lookarounds",
            Utf8RegexBenchmarkOperation.IsMatch,
            "café(?= noir)",
            "café noir " + BuildRepeated("café gris ", 1024),
            RegexOptions.CultureInvariant,
            replacement: null,
            expectedSupport: "Native",
            notes: "UTF-8 positive literal lookahead with an immediate hit."),
        new(
            "ismatch_utf8_lookahead_miss",
            "Lookarounds",
            Utf8RegexBenchmarkOperation.IsMatch,
            "café(?= noir)",
            BuildRepeated("café gris ", 2048),
            RegexOptions.CultureInvariant,
            replacement: null,
            expectedSupport: "Native",
            notes: "UTF-8 positive literal lookahead with only rejected leading candidates."),
        new(
        ...
        new(
            "ismatch_lookahead_early_hit",
            "Lookarounds",
            Utf8RegexBenchmarkOperation.IsMatch,
            "foo(?=bar)",
            "foobar " + BuildRepeated("fooqux ", 1024),
            RegexOptions.CultureInvariant,
            replacement: null,
            expectedSupport: "Native",
            notes: "ASCII positive literal lookahead with an immediate hit."),
        new(
            "ismatch_lookahead_miss",
            "Lookarounds",
            Utf8RegexBenchmarkOperation.IsMatch,
            "foo(?=bar)",
            BuildRepeated("fooqux ", 2048),
            RegexOptions.CultureInvariant,
            replacement: null,
            expectedSupport: "Native",
            notes: "ASCII positive literal lookahead with only rejected leading candidates."),
        new(
            "ismatch_rtl_literal",
            "RightToLeft",
            Utf8RegexBenchmarkOperation.IsMatch,
        ...
        new(
            ...
            replacement: null,
            expectedSupport: "Native",
            notes: "ASCII literal match projection with positive literal lookahead."),
        new(
            "match_lookahead_early_hit",
            "Lookarounds",
            Utf8RegexBenchmarkOperation.Match,
            "foo(?=bar)",
            "foobar " + BuildRepeated("fooqux ", 1024),
            ...
            replacement: null,
            expectedSupport: "Native",
            notes: "ASCII literal lookahead projection with an immediate hit."),
        new(
            "match_lookahead_miss",
            "Lookarounds",
            Utf8RegexBenchmarkOperation.Match,
            "foo(?=bar)",
            BuildRepeated("fooqux ", 2048),
            ...
            replacement: null,
            expectedSupport: "Native",
            notes: "ASCII literal lookahead projection with only rejected leading candidates."),
        new(
        ...
        new(
            "match_utf8_lookahead_early_hit",
            "Lookarounds",
            Utf8RegexBenchmarkOperation.Match,
            "café(?= noir)",
            "café noir " + BuildRepeated("café gris ", 1024),
            ...
            replacement: null,
            expectedSupport: "Native",
            notes: "UTF-8 literal lookahead projection with an immediate hit."),
        new(
            "match_utf8_lookahead_miss",
            "Lookarounds",
            Utf8RegexBenchmarkOperation.Match,
            "café(?= noir)",
            BuildRepeated("café gris ", 2048),
            ...
            replacement: null,
            expectedSupport: "Native",
            notes: "UTF-8 literal lookahead projection with only rejected leading candidates."),
        new(
        ...
        new(
            ...
            replacement: null,
            expectedSupport: "Fallback",
            notes: "Short right-to-left enumeration control with one ASCII hit."),
        new(
            "enumerate_rtl_literal_sparse",
            "RightToLeft",
            Utf8RegexBenchmarkOperation.EnumerateMatches,
            "needle",
            BuildRepeated("haystack ", 4096) + "needle",
            RegexOptions.CultureInvariant | RegexOptions.RightToLeft,
            replacement: null,
            expectedSupport: "Fallback",
            notes: "Sparse right-to-left enumeration control with one terminal ASCII hit."),
        new(
            "enumerate_rtl_literal_miss",
            "RightToLeft",
            Utf8RegexBenchmarkOperation.EnumerateMatches,
            "needle",
            BuildRepeated("haystack ", 4096),
            RegexOptions.CultureInvariant | RegexOptions.RightToLeft,
            replacement: null,
            expectedSupport: "Fallback",
            notes: "Right-to-left ASCII no-match control."),
        new(
            "enumerate_rtl_zero_width",
            "RightToLeft",
            Utf8RegexBenchmarkOperation.EnumerateMatches,
            "(?=a)",
            BuildRepeated("banana ", 4096),
            RegexOptions.CultureInvariant | RegexOptions.RightToLeft,
            replacement: null,
            expectedSupport: "Fallback",
            notes: "Dense right-to-left zero-width ASCII enumeration control."),
        new(
            "enumerate_rtl_utf8_literal",
            "RightToLeft",
            Utf8RegexBenchmarkOperation.EnumerateMatches,
            "café",
            BuildRepeated("café noir ", 4096),
            RegexOptions.CultureInvariant | RegexOptions.RightToLeft,
            replacement: null,
            expectedSupport: "Fallback",
        ...
        new(
            ...
            Utf8RegexBenchmarkOperation.EnumerateMatches,
            "café",
            BuildRepeated("résumé noir ", 4096) + "café",
            RegexOptions.CultureInvariant | RegexOptions.RightToLeft,
            replacement: null,
            expectedSupport: "Fallback",
            notes: "Sparse Unicode RTL projection control with one terminal match."),
        new(
            "enumerate_rtl_utf8_literal_miss",
            "RightToLeft",
            Utf8RegexBenchmarkOperation.EnumerateMatches,
            "café",
            BuildRepeated("résumé noir ", 4096),
            RegexOptions.CultureInvariant | RegexOptions.RightToLeft,
            replacement: null,
            expectedSupport: "Fallback",
            notes: "Unicode RTL no-match projection control."),
        new(
            "enumerate_rtl_supplementary_literal",
            "RightToLeft",
            Utf8RegexBenchmarkOperation.EnumerateMatches,
            "😀",
            BuildRepeated("😀 ok ", 4096),
            ...
            replacement: null,
            expectedSupport: "Fallback",
            notes: "Dense supplementary-scalar RTL projection control."),
        new(
            "enumerate_rtl_utf8_zero_width",
            "RightToLeft",
            Utf8RegexBenchmarkOperation.EnumerateMatches,
            "(?=é)",
            BuildRepeated("café ", 4096),
            ...
            replacement: null,
            expectedSupport: "Fallback",
            notes: "Dense Unicode RTL zero-width projection control."),
        new(
        ...
        new(
            "replace_ascii_multialt",
            "Replace",
            Utf8RegexBenchmarkOperation.Replace,
            "tempus|magna|semper",
            BuildRepeated("tempus magna semper ", 1024),
            RegexOptions.None,
            replacement: "amoveatur",
            expectedSupport: "Native",
            notes: "Fixed replacement over an exact ASCII literal family without invariant-twin routing."),
        new(
            "replace_ascii_multialt_no_match",
            "Replace",
            Utf8RegexBenchmarkOperation.Replace,
            "tempus|magna|semper",
            BuildRepeated("lorem ipsum dolor ", 1024),
            RegexOptions.None,
            replacement: "amoveatur",
            expectedSupport: "Native",
            notes: "No-match exact ASCII literal-family replacement without invariant-twin routing."),
        new(
            "replace_ascii_multialt_short",
            "Replace",
            Utf8RegexBenchmarkOperation.Replace,
            "tempus|magna|semper",
            "tempus magna",
            ...
            replacement: "amoveatur",
            expectedSupport: "Native",
            notes: "Short exact ASCII literal-family replacement without invariant-twin routing."),
        new(
