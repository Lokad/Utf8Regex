...
[MemoryDiagnoser]
public class Utf8Pcre2SpecialCountBenchmarks
{
    ...
    public IEnumerable<string> CaseIds => Utf8Pcre2BenchmarkCatalog.GetIds(Utf8Pcre2BenchmarkOperation.Count, Utf8Pcre2BenchmarkBackend.Pcre2Only)
