...
if (args.Length >= 3 && args[0].Equals("--measure-utf8-offset-case", StringComparison.Ordinal))
{
    return BenchmarkInspectReporter.RunMeasureUtf8OffsetCase(
        args[1],
        args[2],
        args.Length >= 4 ? args[3] : null,
...
if (args.Length >= 1 && args[0].Equals("--emit-readme-parity-report", StringComparison.Ordinal))
{
    return BenchmarkInspectReporter.RunEmitReadmeParityReport();
}

if (args.Length >= 1 && args[0].Equals("--verify-readme-parity-report", StringComparison.Ordinal))
{
...
{
    return BenchmarkInspectReporter.RunMeasureCompiledLiteralFamilyReplicaCase(
        args[1],
        args.Length >= 3 ? args[2] : null,
        args.Length >= 4 ? args[3] : null);
}
